...
\begin{figure}[H]
    ...
    \subfloat[Авторизация в NEAR Wallet в near-api-js]{
        \includegraphics[height=50mm]{fig/auth1.png}
        \label{fig.nearauth.a}
    }
    \subfloat[Авторизация в NEAR Wallet в discord-боте]{
        \includegraphics[height=70mm]{fig/auth2.png}
