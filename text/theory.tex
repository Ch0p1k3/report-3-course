...
С точки зрения написания смарт-контрактов Paras имеет абсолютно такую же структуру NFT смарт-контракта, потому что они поддерживаются стандарта ~\cite{nftstandart}(см. 4.1).
